...
import com.talk.dialog.GravityEnum;
import com.talk.dialog.R;
import com.talk.dialog.TalkDialog;

public class TalkSimpleListAdapter extends ArrayAdapter<TalkSimpleListItem> {

    private TalkDialog dialog;

    public void setDialog(TalkDialog dialog) {
        setDialog(dialog, true);
    }

    public void setDialog(TalkDialog dialog, boolean notifyDataSetChanged) {
        this.dialog = dialog;
        if (notifyDataSetChanged)
            notifyDataSetChanged();
    }

    public TalkSimpleListAdapter(Context context) {
        super(context, R.layout.talk_simplelist_item, android.R.id.title);
    }
    ...
    public View getView(final int index, View convertView, ViewGroup parent) {
        ...
        if (dialog != null) {
            final TalkSimpleListItem item = getItem(index);
