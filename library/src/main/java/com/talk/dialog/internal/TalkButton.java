package com.talk.dialog.internal;
...
public class TalkButton extends TextView {
    ...
    public TalkButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        mStackedEndPadding = context.getResources()
                .getDimensionPixelSize(R.dimen.talk_dialog_frame_margin);
