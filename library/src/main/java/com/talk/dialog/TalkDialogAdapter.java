...
import com.talk.dialog.internal.TalkTintHelper;

class TalkDialogAdapter extends BaseAdapter {

    private final TalkDialog dialog;
    @LayoutRes
    ...
    public TalkDialogAdapter(TalkDialog dialog, @LayoutRes int layout) {
        this.dialog = dialog;
        this.layout = layout;
    ...
    public View getView(final int index, View view, ViewGroup parent) {
        if (view == null)
            view = LayoutInflater.from(dialog.getActivity()).inflate(layout, parent, false);
        ...
        switch (dialog.listType) {
            case SINGLE: {
                ...
                TalkTintHelper.setTint(radio, dialog.mBuilder.widgetColor);
            ...
            case MULTI: {
                ...
                TalkTintHelper.setTint(checkbox, dialog.mBuilder.widgetColor);
